        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold text-white">ObscuraMask</span>
              </div>
              <p className="text-sm text-gray-400">
                Secure your sensitive data with military-grade encryption and advanced file masking technology.
              </p>
              {/* Social Links */}
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="/support" className="hover:text-indigo-400 transition-colors">Support Center</Link></li>
                <li><Link href="/status" className="hover:text-indigo-400 transition-colors">System Status</Link></li>
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mb-4">Subscribe to our newsletter for updates and tips.</p>
              <form className="space-y-2">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="w-full px-4 py-2 rounded-lg bg-gray-800 border border-gray-700 focus:outline-none focus:border-indigo-500 text-sm"
                />
          ...
          <div className="border-t border-gray-800 pt-8 mt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              {/* Legal Links */}
              <ul className="flex flex-wrap gap-6 text-sm mb-4 md:mb-0">
                <li>
              ...
              <p className="text-gray-500 text-sm">
                © {new Date().getFullYear()} ObscuraMask. All rights reserved.
              </p>
            </div>
          </div>
        </div>
